...
public class PaymentDataBView extends JPanel {
   ...
   private void initComponents() {
       ...
       backButton.setIcon(new ImageIcon(getClass().getResource("/it/unipv/ingsw/syzygy/excamp/resources/backArrow.png")));
       backButton.setBackground(new Color(145, 186, 214));
       // Configure nextButton
       nextButton.setIcon(new ImageIcon(getClass().getResource("/it/unipv/ingsw/syzygy/excamp/resources/nextArrow.jpg")));
       ...
       JLabel bankImage = new JLabel(new ImageIcon(getClass().getResource("/it/unipv/ingsw/syzygy/excamp/resources/bankLogo.png")));
