...
public class ProgrammaGiornaliero {
   ...
   public ProgrammaGiornaliero(String data, List<Attività> attivita, Location location, Camp camp) {
       this.data = data;
   ...
   public String toString() {
       ...
       sb.append("Programma del giorno ").append(data).append(" a ").append(location).append(" per il camp: ").append(camp).append("\n");
